...
.. |travis| image:: https://api.travis-ci.org/erpbrasil/nfselib.dsf.svg?branch=master_gen
    :alt: Travis-CI Build Status
    :target: https://travis-ci.org/erpbrasil/nfselib.dsf

.. |appveyor| image:: https://ci.appveyor.com/api/projects/status/github/erpbrasil/nfselib.dsf?branch=master_gen&svg=true
    :alt: AppVeyor Build Status
    :target: https://ci.appveyor.com/project/mileo/nfselib-dsf

.. |codecov| image:: https://codecov.io/gh/erpbrasil/nfselib.dsf/branch/master_gen/graphs/badge.svg?branch=master_gen
    :alt: Coverage Status
    :target: https://codecov.io/github/erpbrasil/nfselib.dsf

.. |version| image:: https://img.shields.io/pypi/v/nfselib.dsf.svg
    :alt: PyPI Package latest release
    :target: https://pypi.org/project/nfselib.dsf

.. |wheel| image:: https://img.shields.io/pypi/wheel/nfselib.dsf.svg
    :alt: PyPI Wheel
    :target: https://pypi.org/project/nfselib.dsf

.. |supported-versions| image:: https://img.shields.io/pypi/pyversions/nfselib.dsf.svg
    :alt: Supported versions
    :target: https://pypi.org/project/nfselib.dsf

.. |supported-implementations| image:: https://img.shields.io/pypi/implementation/nfselib.dsf.svg
    :alt: Supported implementations
    :target: https://pypi.org/project/nfselib.dsf

.. |commits-since| image:: https://img.shields.io/github/commits-since/erpbrasil/nfselib.dsf/v0.1.0.svg
    :alt: Commits since latest release
    :target: https://github.com/erpbrasil/nfselib.dsf/compare/v0.1.0...master

.. end-badges

Python Library to genereate NFS-E Dsf
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Biblioteca Python para ler e gerar NFSe's / XML para o webservice do DSF:
...
* **Simples e confiável**. O código é gerado pelo generateDS a partir dos XSD's do dsf. Ele **reflete exatamente a especificação fiscal** da versão do esquema escolhida sem que você deva se perguntar qual é o grau de aderência do código;
...
::
    ...
    pip install nfselib.dsf

You can also install the in-development version with::

    pip install https://github.com/erpbrasil/nfselib.dsf/archive/master_gen.zip
